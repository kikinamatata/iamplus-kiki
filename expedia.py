...
class Expedia(Scraper):      
    ...
    async def get_travel_iternity(self,trip_element:ElementHandle) -> Result:
           #Get price 
            ...
            airlines_name_element  = await trip_element.query_selector('div.uitk-text.truncate-lines-2.uitk-type-200.uitk-text-default-theme')  
            ...
            time_element  = await trip_element.query_selector('span.uitk-text.uitk-type-400.uitk-type-medium.uitk-text-emphasis-theme') 
