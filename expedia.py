 ...
 #write a code for         
    ...
    async def scrape_website(self,json_folder_name, sort_by='bestflight_a'):
        async with async_playwright() as p:
            ...
            # return_url = 'https://www.expedia.com/Flights-Search?flight-type=on&leg1=from:'+ c1+',to:'+ c2
            # return_url+= ',departure:'+t1+'TANYT'+'&mode=search&options=cabinclass:economy&passengers=adults:1,infantinlap:N&trip=oneway'
            ...
            # html_text = await page.content()
            # print(html_text), await browser.close()
            ...
            #         travel_result:Result = self.get_travel_iternity(trip_element) 
            #         itinerary.price += travel_result.price
            #         itinerary.return_airlines = travel_result.airlines_name
            #         itinerary.return_start_time = travel_result.start_time
            #         itinerary.return_end_time = travel_result.end_time
...
if __name__ == "__main__":
    ...
    asyncio.run(expedia.scrape_website(json_folder_name,sort_by_cheapest))
